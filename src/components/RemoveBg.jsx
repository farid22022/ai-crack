...
const RemoveBg = () => {
    ...
    const onSubmit = async (data) => {
        ...
        form.append('image_file', photo);
            ...
            const dbRes = await axios.post("https://ai-photo-crack.vercel.app/bgremoving/bgremovePost", imageDetails);
    ...
    return (
        <div className="mx-auto">
            <Title className="p-5 ml-4 mb-10">Remove Background</Title>
            <div className="mt-10 ml-12">
                <h3 className="ml-8">The original image should be a PNG, JPEG or WebP file, with a maximum resolution of 16 megapixels and a max file size of 30 Mb.</h3>
            </div>
            <form
